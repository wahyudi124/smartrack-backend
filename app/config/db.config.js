...
db.rectifier_report = require('../model/rectifier/rectifier_report_model.js')(sequelize,Sequelize)
...
db.rectifier_profile.hasMany(db.rectifier_report,{foreignKey:'id_profile',sourceKey:'id'})
db.rectifier_report.belongsTo(db.rectifier_profile, {foreignKey:'id_profile',targetKey: 'id'})
...
db.ups_report = require('../model/ups/ups_report_model.js')(sequelize,Sequelize)
...
db.ups_profile.hasMany(db.ups_report,{foreignKey:'id_profile',sourceKey:'id'})
db.ups_report.belongsTo(db.ups_profile, {foreignKey:'id_profile',targetKey: 'id'})
...
db.battery_report = require('../model/battery/battery_report_model')(sequelize,Sequelize)
...
db.battery_profile.hasMany(db.battery_report,{foreignKey:'id_profile',sourceKey:'id'})
db.battery_report.belongsTo(db.battery_profile, {foreignKey:'id_profile',targetKey: 'id'})
...
db.aircond_report = require('../model/aircond/aircond_report_model')(sequelize,Sequelize)
...
db.aircond_profile.hasMany(db.aircond_report,{foreignKey:'id_profile',sourceKey:'id'})
db.aircond_report.belongsTo(db.aircond_profile, {foreignKey:'id_profile',targetKey: 'id'})
...
db.pdu_report = require('../model/pdu/pdu_report_model')(sequelize,Sequelize)
...
db.pdu_profile.hasMany(db.pdu_report,{foreignKey:'id_profile',sourceKey:'id'})
db.pdu_report.belongsTo(db.pdu_profile, {foreignKey:'id_profile',targetKey: 'id'})
